import MenuButton from '@shared/button/Menu-button';
import SearchButton from '@shared/button/Search-button';

function Header() {
  return (
    <header className="fixed flex flex-row items-center justify-between px-15 pt-16 pb-6 text-default-white w-full">
      <MenuButton />
      <h1 className="fixed top-[80px] left-[50%] translate-[-50%]">
        <a href="#">
          <svg width="88" height="36" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380 156" fill="#f2f2f7">
